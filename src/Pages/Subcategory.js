                                                ...
                                                <div className="row">
                                                    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div className="_instrctr_new_itm _mar_b24">
                                                            ...
                                                            <Input type="text" placeholder="Website name" className="_inpt1" />
                                                        </div>
                                                    </div>
                                                    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div className="_instrctr_new_itm _mar_b24">
                                                            ...
                                                            <Input type="text" placeholder="Category name" className="_inpt1" />
                                                        </div>
                                                    </div>
                                                    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div className="_instrctr_new_itm _mar_b24">
                                                            ...
                                                            <Input type="text" placeholder="Subcategory name" className="_inpt1" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div className="_instrctr_new_itm _mar_b24">
                                                            ...
                                                            <Input type="number" placeholder="ID" className="_inpt1" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
